...
// encode rgba frames to an mp4/webm file by piping rawvideo to ffmpeg. mp4 has no
// alpha (yuv420p); webm keeps alpha via vp9/yuva420p. dimensions are padded to
// even numbers as the codecs require.
